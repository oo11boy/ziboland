      ...
      <div className="flex justify-between text-white min-lg-none items-center fixed z-50 w-full h-[60px] p-4 bg-black shadow-md transition-all duration-300">
        <div className="flex justify-start w-full items-center gap-2">
          <form action="" className="w-full relative">
            <input
              type="text"
              className="w-full outline-none text-black yekannew pl-8 p-2 rounded-lg bg-gray-200"
              value={inputValue}
              onChange={handleInputChange}
            />
            <Search className="absolute left-2 top-2 text-[#777777]" />
            {!inputValue && (
              <div className="custom-placeholder flex items-center gap-2 yekannew  absolute right-2 top-2 pointer-events-none">
                <p>
                جستجو در
                </p>
