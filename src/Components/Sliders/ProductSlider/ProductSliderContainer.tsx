                      ...
                      <div className="flex gap-1.5 justify-center mb-2 h-4 items-center">
                        {item.variants?.map((variant) => (
                          <button 
                            ...
                            className={`w-3 h-3 md:w-4 md:h-4 rounded-full border border-gray-200 transition-transform ${selectedVariants[item.id]?.id === variant.id ? 'scale-125 ring-2 ring-blue-400' : ''}`} 
                    ...
                    <div className="mt-auto pt-2 border-t border-gray-50">
                      <div className="flex flex-col mb-3">
                        <span className="text-[10px] md:text-xs text-gray-400 line-through h-4 leading-none italic font-medium">
                          {discountBadge !== "0" ? formatPrice(originalPriceNum) : ""}
                        </span>
