...
const ArticlePage: React.FC<ArticlePageProps> = ({
  ...
  return (
    <div className="flex flex-col bg-gray-100 w-full min-h-screen pb-16">
      ...
      {/* محتوای مقاله */}
      <div className="flex flex-col items-center z-2 -mt-40 md:-mt-40 px-4">
        <div className="w-full lg:w-[90%] bg-white rounded-xl shadow-lg p-6 sm:p-10 flex flex-col gap-6">
          <h1 className="text-xl sm:text-3xl font-extrabold text-gray-900">{title}</h1>
          ...
          {/* متن مقاله */}
          <div className="flex flex-col gap-4 text-gray-800 text-base sm:text-lg leading-relaxed">
        ...
        {/* اشتراک‌گذاری مقاله */}
        <div className="w-full lg:w-[90%] mt-8 bg-white rounded-xl shadow-lg p-6 sm:p-10 flex flex-col gap-4">
          <h2 className="text-xl font-bold text-gray-900">اشتراک‌گذاری این مقاله</h2>
          <div className="flex gap-4 mt-2">
            {socialPlatforms.map((platform) => (
              <a
                ...
                className="bg-gray-200 p-3 rounded-lg hover:bg-indigo-600 hover:text-white transition-colors flex items-center justify-center"
              >
                {platform.icon}
              </a>
            ))}
